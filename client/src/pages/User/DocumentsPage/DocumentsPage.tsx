...
const DocumentsPage = () => {
    ...
    const sectionsWithDocuments = [
        {
            "_id": "62130d13257854d12a878a8b",
            "title": "Для студентов",
            "documents": [
                {
                    "_id": "621336d3103d4ac0b87cef8b",
                    "type": "link",
